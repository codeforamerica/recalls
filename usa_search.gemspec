# -*- encoding: utf-8 -*-
require File.expand_path("../lib/usa_search/version", __FILE__)
...
Gem::Specification.new do |s|
  ...
  s.description = %q{A Ruby wrapper for the USASearch APIs.}
  s.post_install_message =<<eos
Using this gem in your project or organization? Add it to the apps wiki!
https://github.com/codeforamerica/USASearch/wiki/apps
eos
  s.email = ["dan@codeforamerica.org"]
  s.executables = `git ls-files -- bin/*`.split("\n").map{ |f| File.basename(f) }
  s.files = `git ls-files`.split("\n")
  s.homepage = "http://rubygems.org/gems/USASearch"
  s.name = "USASearch"
